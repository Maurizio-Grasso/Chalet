<?php
 ...
 return [
    ...
    [
        'title'=> 'Chalet Falzarego',
        'address'=> 'Passo Falzarego, 7-6, 32043 Cortina d\'Ampezzo BL',
        'user_id'=>2,
        'rooms_n'=>2,
        'beds_n'=>4,
        'bathroom_n'=>2,
        ...
        'latitude'=>'46.518877',
        'longitude'=>'12.009287',
        'description'=>'<p>Accogliente Chalet proprio di fronte la splendida funivia che conduce al Rifugio Lagazuoi, la terrazza delle Dolomiti.</p><p>Lo chalet è strutturato su due piani e dispone di due camere da letto per un totale di 4 ospiti. Su richiesta forniamo una culla per bambini a titolo gratuito.</p>
        <p>Al piano inferiore, gli ospiti troveranno una cucina superaccessoriata, salotto/soggiorno con divano letto e camino , bagno e giardino attrezzato.</p>
        <p>Aperto tutto l\'anno, Chalet Falzarego è perfetto per chi ama praticare sport come sci, trekking, climbing o biking, ma anche per chi, più semplicemente, vuole trascorrere un periodo di meritato relax!</p>',
        'visible'=>'1',
        'price_per_night'=>155.00,
        'rating'=>4,
    ],
    ...
    [
        ...
        'latitude'=>'46.136155',
        'longitude'=>'10.377523',
        'description'=>'L\'appartamento è situato nel centro storico di Baselga di Piné, a due passi da Piazza Garibaldi, sede del Teatro Sociale, dal MVSA (Museo Valtellinese di Storia ed Arte) e delle sedi delle Banche locali e non.
    ...
    [
        'title'=> 'Chalet nel Centro',
        'address'=>'Via Provagna, 9, 32013 Longarone BL',
        'user_id'=>3,
        'rooms_n'=>2,
        'beds_n'=>4,
        'bathroom_n'=>1,
    ...
    [
        'title'=> 'La Piccola Mansarda',
        'address'=>'Località Baufie, 33020 Forni di Sotto UD',
        'user_id'=>2,
        'rooms_n'=>3,
        'beds_n'=>2,
        'bathroom_n'=>1,
    ...
    [
        'title'=> 'Design Chalet \'Al Pino\'',
        'address'=>'Località Roste, 1, 32020 Rivamonte Agordino BL',
        'user_id'=>2,
        'rooms_n'=>2,
        'beds_n'=>2,
        'bathroom_n'=>2,
        ...
        'latitude'=>'46.264066',
        'longitude'=>'12.034412',
        'description'=>'All\'ultimo piano di un importante edificio degli anni \'50, con magnifica vista sulle Dolomiti di Agordo, affittiamo monolocale di design arricchito da arredi storici esposti alla XI Triennale di Milano nel \'51.
    ...
    [
        'title'=> 'l\'Atico Chalet delle Alpi',
    ...
    [
        ...
        'latitude'=>'46.550333',
        'longitude'=>'12.183731',
        'description'=>'Baita Monti Pallidi rappresenta il lato migliore dell’hotellerie nelle Dolomiti: la tradizione di montagna si unisce con le esigenze della modernità.
    ...
    [
        ...
        'address'=>'Via Monte Piana, 5, 32041 Auronzo di Cadore BL',
        'user_id'=>1,
        'rooms_n'=>6,
        'beds_n'=>3,
        'bathroom_n'=>2,
    ...
    [
        'title'=> 'Il Piz',
        'address'=>'Ahnerberg 105, 39037 Rodengo BZ',
        'user_id'=>1,
        'rooms_n'=>6,
        'beds_n'=>3,
        'bathroom_n'=>2,
    ...
    [
        'title'=> 'Chalet Gerardo',
        'address'=>'Oberplanken, 9, 39030 Valle di Casies BZ',
        'user_id'=>1,
        'rooms_n'=>2,
        'beds_n'=>3,
        'bathroom_n'=>2,
    ...
    [
        'title'=> 'Chalet dal NaN',
        'address'=>'Località Pranolz, 77, 32028 Borgo Valbelluna BL',
        'user_id'=>2,
        'rooms_n'=>2,
        'beds_n'=>3,
        'bathroom_n'=>2,
    ...
    [
        'title'=> 'Baita Coldai',
        'address'=>'Via del Gonfet, 7-8, 32010 Mareson-Pecol BL',
        'user_id'=>2,
        'rooms_n'=>1,
        'beds_n'=>3,
        'bathroom_n'=>1,
    ...
    [
        'title'=> 'Garni Monte Civetta',
        'address'=>'Via Caracoi Cimai, 32023 Caracoi Cimai BL',
        'user_id'=>3,
        'rooms_n'=>1,
        'beds_n'=>2,
        'bathroom_n'=>1,
    ...
    [
        'title'=> 'Baia Antelao',
        'address'=>'Via Metanopoli, 328, 32040 Corte BL',
        'user_id'=>1,
        'rooms_n'=>2,
        'beds_n'=>4,
        'bathroom_n'=>2,
    ...
    [
        'title'=> 'All\'ombra delle Dolomiti',
        'address'=>'Str. Glira, 17, 39030 San Cassiano BZ',
        'user_id'=>3,
        'rooms_n'=>3,
        'beds_n'=>7,
        'bathroom_n'=>3,
    ...
    [
        'title'=> 'Baita Croda da Lago',
        'address'=>'Loc. Pien de Vacia, 32020 Selva di Cadore BL',
        'user_id'=>3,
        'rooms_n'=>1,
        'beds_n'=>3,
        'bathroom_n'=>1,
    ...
    [
        'title'=> 'Baita Croda da Lago',
        'address'=>'Localita, Rüdiferia, 24, 39036 San Cassiano BZ',
        'user_id'=>1,
        'rooms_n'=>3,
        'beds_n'=>6,
        'bathroom_n'=>2,
    ...
    [
        'title'=> 'Pensione della Piana',
        'address'=>'Via al Castello, 28, 39030 Villa Ottone BZ',
        'user_id'=>3,
        'rooms_n'=>2,
        'beds_n'=>5,
        'bathroom_n'=>3,
    ...
    [
        'title'=> 'Chalet dei Sogni',
        'address'=>'località Miola 1, 38037 Predazzo TN',
        'user_id'=>2,
        'rooms_n'=>1,
        'beds_n'=>2,
        'bathroom_n'=>1,
    ...
    [
        'title'=> 'La Baita nel Bosco',
        'address'=>'Via Costalta, 32045 Costalissoio BL',
        'user_id'=>3,
        'rooms_n'=>4,
        'beds_n'=>8,
        'bathroom_n'=>4,
